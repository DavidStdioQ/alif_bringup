...
def version_decode(isp, message):
    ...
    if len(message) == 136:
        ...
        isp_print_color("blue",hex(int.from_bytes(HBK0,"little")))
        print("")

        HBK1 = (message[38:54]) #bytes 38-53 (limit 54)
        isp_print_color("blue"," HBK1\t\t=  ")
        isp_print_color("blue",hex(int.from_bytes(HBK1,"little")))
        print("")
        ...
        isp_print_color("blue",hex(int.from_bytes(MfgData,"little")))
        print("")
